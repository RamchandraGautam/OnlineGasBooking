    ...
    public partial class createDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_admin_Employee", x => x.EmpID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NewConnectionID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    First_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Last_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Gender = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Phone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DocPicturePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomerID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewConnection", x => x.NewConnectionID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    admin_EmployeeEmpID = table.Column<int>(type: "int", nullable: false),
                    RoleID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_admin_Login", x => x.LoginID);
                    table.ForeignKey(
                        name: "FK_admin_Login_admin_Employee_admin_EmployeeEmpID",
                        column: x => x.admin_EmployeeEmpID,
                        principalTable: "admin_Employee",
                        principalColumn: "EmpID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_admin_Login_Roles_RoleID",
                        column: x => x.RoleID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_ShippingDetails_ShippingDetailShippingID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_admin_Login_admin_EmployeeEmpID",
                table: "admin_Login",
                column: "admin_EmployeeEmpID");

            migrationBuilder.CreateIndex(
                name: "IX_admin_Login_RoleID",
                table: "admin_Login",
                column: "RoleID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_ShippingDetailShippingID",
                table: "Order",
